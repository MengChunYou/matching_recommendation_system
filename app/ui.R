...
shinyUI(fluidPage(
    ...
    titlePanel("Dota2 Hero Recommendation System"),
    
    sidebarLayout(
        
        sidebarPanel(
            
            # Drop down List to Choose a hero
            selectInput(inputId = "Hero", 
                        label = "Choose a hero to see its recommendation:",
                        choices = c(
                            ...
                            "Lich",                "Lifestealer",         "Lina",                "Lion",                "Lone Druid",          "Luna",               
                            "Lycan",               "Magnus",              "Mars",                "Medusa",              "Meepo",               "Mirana",             
        ...
        mainPanel(
            tabsetPanel(
                ...
                tabPanel(title = "Matching Hero Graph",
                         sliderInput(inputId = "Maximum",
                                     label = "Maximum matching hero to show:",
                                     min = 1,
                                     max = 25,
                                     value = 10),
                         plotOutput("egonetwork")),
                         
                tabPanel(title = "Matching Hero Rank",
